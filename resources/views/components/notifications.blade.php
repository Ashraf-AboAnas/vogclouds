...
<div class="dropdown nav-item main-header-notification">
    ...
    <a class="new nav-link" href="#">
       <sup><span  style="font-size:10px" class="badge badge-info"> {{Auth::user()->unreadNotifications()->count()}}</span></sup>
        ...
        <div class="main-notification-list Notification-scroll  ">
            @foreach (Auth::user()->Notifications as $notification)
             ...
             {{-- <a class="d-flex p-3 border-bottom" href= "{{$notification->data['action']}}"> --}}
                <a class="d-flex p-3 border-bottom" href= "{{route('read.notifation',$notification->id)}}">
                <div class="notifyimg">
                 ...
                 <div class="mr-3">
                    <h5 class="notification-label mb-1">  @if($notification->unread()) <i class="far fa-star"></i> @endif {{$notification->data['title']}}   {{$notification->data['body']}}
