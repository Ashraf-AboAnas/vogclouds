                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @if($ticket->invoice->client_ok =='0' )
                                                <button class="btn btn-outline-success btn-sm"
                                                onclick="event.preventDefault();
                                                document.getElementById('form-completei-{{$ticket->id}}').submit()"
                                                   >تاكيد الفاتوره </button>




                                                    <form style="display:none"  id="{{'form-completei-'.$ticket->id}}" method="post"
                                                       action ="{{route('ticket.ok',$ticket->id)}}">
