...
<h2 class="about-us-page-title-sub-title" style="font-size:40px;color:#37517e;text-align: center;font-weight: 500;position: relative;font-family: 'Cairo', sans-serif;">مزايا تصميمات ڤوق كلاود</h2>
<p class="about-us-page-title-text" style="text-align:center;margin:auto;font-size:20px;padding-bottom: 60px;color: #556877;width:70%;font-family: 'Cairo', sans-serif;">نعلم دائما ان التصميم هو اللمسة الجمالية التي تضيف الى موقعك روح الانبهار , و هو ايضا عامل جذب مهم للزوار لذلك نحن كفريق عمل نبذل اقصى ما في جهدنا لكي ننال رضاكم و نخرج لكم تصميم يحمل الاختلاف . كما تتخيل انت و يناسب جميع الاذواق باستخدام احدث التقنيات المستخدمة في تصميم المواقع ليكون تصميم الموقع متوافقا مع المعايير القياسية لتصميم المواقع و صديق لمحركات البحث .</p>
</div>
</div>
...
<div class="wp-plan-features-box left-side-box" style=" margin-top:50px;">
<div class="wp-plan-features-number">01</div>
<div class="wp-plan-features-text">تصميم المواقع</div>
</div>
<div class="wp-plan-features-box second-left left-side-box">
<div class="wp-plan-features-number">02</div>
<div class="wp-plan-features-text">برمجة التطبيقات</div>
</div>
<div class="wp-plan-features-box second-left left-side-box">
<div class="wp-plan-features-number">03</div>
<div class="wp-plan-features-text"> UI/UX</div>
</div>
</div>
<div class="col-md-4 mr-tp-100 " id="circle">

<img src="{{asset('assets/img/images.jpg')}}" class="" style="border-radius: 50%; margin-right:-20px;width:380px;height:400px; box-shadow:
...
<div class="wp-plan-features-box" style=" margin-top:50px;">
<div class="wp-plan-features-number">04</div>
<div class="wp-plan-features-text">المتاجر الإلكترونية</div>
</div>
<div class="wp-plan-features-box second-right">
<div class="wp-plan-features-number">05</div>
<div class="wp-plan-features-text">برمجة النظم</div>
</div>
<div class="wp-plan-features-box second-right">
<div class="wp-plan-features-number">06</div>
<div class="wp-plan-features-text">برمجة المواقع</div>
</div>
</div>
</div>
</div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-right text-lg-right">
            <h3 style="font-family:'Cairo',sans-serif;">هل تفكر فى بدء مشروع جديد على الانترنت؟</h3>
            <p class="description" style="line-height: 24px;font-size:14px;font-family: 'Cairo', sans-serif;color: #fff">
										لا تبحث كثيرا, مع فريق التصميم والبرمجة فى ڤوق كلاود, يمكننا تنفيذ مشاريعك الإلكترونية بأقل ميزانية ممكنه وبأفضل جودة.</p>
 ...
 <section id="cta" class="cta section-bg" style="height:300px;">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-right text-lg-right">
            <h3 style="font-family:'Cairo',sans-serif;">إبدأ مشروعك الإلكترونى معنا اليوم!</h3>
            <p class="description" style="line-height: 24px;font-size:14px;font-family: 'Cairo', sans-serif;color: #fff">إرسال لنا تفاصيل طلبك, وسيقوم أحد المختصين فى قسم البرمجة بتقييم السعر المناسب لتنفيذ طلباتك.</p>
